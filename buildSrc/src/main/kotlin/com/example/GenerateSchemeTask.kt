...
import org.telegram.tlrpc.models.SchemaRules
...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val tlSchemaFilter = tlSchemaFull.applyRules(SchemaRules.rules)
        ...
        val dep = SchemaRules.rules.databaseTypes
    ...
    private fun generateSchemeClassForType(
        ...
        for (constructor in constructors) {
            ...
            if (!SchemaRules.rules.filterConstructor(constructor.tl.key.name)) continue
